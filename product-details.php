					...
					<div class="product-details"><!--product-details-->
						<div class="col-sm-5">
							<div class="view-product">
								...
								<img src="images/home/<?= $detail->img; ?>" alt="" />
								<h3>ZOOM</h3>
							</div>
						...
						<div class="col-sm-7">
							<div class="product-information"><!--/product-information-->
								...
								<span>
									<span><?= number_format($detail->price, 2,',',' '); ?>Fcfa</span>
									<!-- <label>Quantité:</label>
									<input type="text" value="3" /> -->
									<a type="button" id="panier" href="functions/add-product.php?id=<?= $detail->id; ?>" class="btn btn-fefault cart" data-toggle="modal" data-target="#flipFlop">
							...
							<div class="tab-pane fade active in" id="reviews" >
								<div class="col-sm-12">
									...
									<form action="#">
										...
										<b>Evaluer le produit: </b> <img src="images/product-details/rating.png" alt="" />
								...
								<div class="item">	
									<div class="col-sm-4">
										<div class="product-image-wrapper">
											<div class="single-products">
												<div class="productinfo text-center">
													<img src="images/home/poulet de chair.jpg" alt="" />
													<h2>$56</h2>
													<p>Easy Polo Black Edition</p>
													<button type="button" class="btn btn-default add-to-cart"><i class="fa fa-shopping-cart"></i>Ajouter au panier</button>
												</div>
									...
									<div class="col-sm-4">
										<div class="product-image-wrapper">
											<div class="single-products">
												<div class="productinfo text-center">
													<img src="images/home/m1.jpg" alt="" />
													<h2>$56</h2>
													<p>Easy Polo Black Edition</p>
													<button type="button" class="btn btn-default add-to-cart"><i class="fa fa-shopping-cart"></i>Ajouter au panier</button>
												</div>
